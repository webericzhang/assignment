(function () {
    ...
    librarian.config(["$routeProvider", function ($rootProvider) {
        $rootProvider
            ...
            .when("/updatingCourse", {
                templateUrl: "partials/updatingCourse.html",
    ...
    librarian.controller("UpdateCourseCtrl", ["$scope", "$location", "CourseServiceResource", "TeacherServiceResource", "LevelServiceResource", 
        function ($scope, $location, CourseServiceResource, TeacherServiceResource, LevelServiceResource) {
